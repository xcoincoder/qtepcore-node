...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `qtepcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ qtepcore-node add wallet-service');
      console.log('    $ qtepcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ qtepcore-node remove wallet-service');
      console.log('    $ qtepcore-node remove insight-api');
      console.log();
    });
