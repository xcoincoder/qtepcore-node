...
/**
 * Will return the path and qtepcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'qtepcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'qtepcore-node.json'))
  };
}
