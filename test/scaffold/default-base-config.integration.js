...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    qtepd.spawn.datadir.should.equal(home + '/.qtep');
    qtepd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/qtepd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.qtepd.spawn.datadir.should.equal('./data2');
  });
});
